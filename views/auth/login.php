...
<head>
    ...
    <!-- Titulo de la pagina de login actualizado -->
    <title>Iniciar Sesion - TecnoSoluciones-Gestor</title>
    <style>
...
<body>
    <div class="container">
        <div class="card">
            ...
            <?php endif; ?>
            <!-- Formulario de login con token CSRF -->
            <form method="POST">
            ...
            <!-- Informacion de demo para pruebas -->
            <div class="demo-info">
